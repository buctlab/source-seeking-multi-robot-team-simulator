...
from numpy import asarray, apply_along_axis, where, argsort, arctan, pi, sin, tan, fabs, sqrt, sum, zeros, concatenate, \
    append
...
class SquirrelSearchAlgorithm(Algorithm):
    ...
    def run(self):
        ...
        while not self.stopping_criteria(self.iter):
            ...
            acorn_nuts_trees_loc = asarray(
                [self.acorn_to_hickory(acorn_nuts_trees_loc[i], hickory_nut_tree_loc) for i in
