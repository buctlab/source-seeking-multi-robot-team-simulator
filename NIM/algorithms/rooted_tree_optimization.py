...
from NIM.benchmarks.rastrigin import Rastrigin
...
if __name__ == '__main__':
    from NIM.benchmarks import *
    rt = RootedTreeOptimization(func=Holdertable(), iterations=100, debug=True, population=30)
    rt.run()
