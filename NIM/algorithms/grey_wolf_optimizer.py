...
class GreyWolfOptimizer(Algorithm):
    ...
    def update_position(self, wolf_pos, a, alpha_pos, beta_pos, delta_pos):
        r"""Update the Position of search robots including omegas

        :param wolf_pos: Position of a search robot
        :param a: parameter
        :param alpha_pos: Position of the best search robot
        :param beta_pos: Position of the second best search robot
        :param delta_pos: Position of the third best search robot
        :return: New position of current search robot
        """
